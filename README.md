...
|------|----------|----------|-------------|
| Admin | admin | admin123 | Full system access + WhatsApp config |
| Pharmacist | dr.sarah | pharmacist123 | Customer service & prescriptions |
| Pharmacist | siti.pharmacist | pharmacist456 | Customer service & prescriptions |
| Restoker | budi.restoker | restoker123 | Inventory management |
